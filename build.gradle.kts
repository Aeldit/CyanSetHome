...
object C {
    const val MOD_VERSION: String = "1.1.10"
    const val LOADER_VERSION: String = "0.16.13"
    const val CYANLIB_VERSION: String = "1.0.6"
...
dependencies {
    ...
    val debug = false
    if (debug) {
        modImplementation(files(projectDir.resolve("../../run/mods/cyanlib-1.0.6-test1+1.21.5.jar")))
    } else {
...
publishMods {
    modrinth {
        ...
        projectId = "9auOqb3o"
        displayName = "[${mod.rangedName}] CyanSetHome ${C.MOD_VERSION}"
